...
def index_to_move_action(action):
    return {
        0: [Action.P1_LEFT],
        1: [Action.P1_LEFT, Action.P1_UP],
        2: [Action.P1_UP],
        3: [Action.P1_UP, Action.P1_RIGHT],
        4: [Action.P1_RIGHT],
        5: [Action.P1_RIGHT, Action.P1_DOWN],
        6: [Action.P1_DOWN],
        7: [Action.P1_DOWN, Action.P1_LEFT],
        8: []
    }[action]
...
def index_to_attack_action(action):
    return {
        ...
        1: [Action.P1_SPUNCH],
        2: [Action.P1_FPUNCH],
        3: [Action.P1_JPUNCH, Action.P1_SPUNCH],
        4: [Action.P1_SKICK],
        5: [Action.P1_FKICK],
        6: [Action.P1_RKICK],
        7: [Action.P1_SKICK, Action.P1_FKICK],
        8: [Action.P1_JPUNCH, Action.P1_SKICK],
        9: []
    }[action]
